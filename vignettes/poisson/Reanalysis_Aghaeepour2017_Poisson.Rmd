...
gof = function(tb) {
  tb %>% 
    group_by(term) %>% 
    summarize(
      pSTAT_bright = mean(pSTAT1 > pSTAT1_median & pSTAT3 > pSTAT3_median & pSTAT5 > pSTAT5_median),
      pSTAT1_bright_35_dim = 
        mean(pSTAT1 > pSTAT1_median & pSTAT3 < pSTAT3_median & pSTAT5 < pSTAT5_median),
      zero_pERK1_2 = mean(pERK1_2  == 0),
      nonzero_pMAPKAPK = mean(pMAPKAPK > pMAPKAPK_median)
      )
}
