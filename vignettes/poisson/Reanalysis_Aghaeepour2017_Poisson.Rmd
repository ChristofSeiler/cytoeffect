...
# sample all tables
mu_hat1 = sample_mu_hat(k = 1)
mu_hat2 = sample_mu_hat(k = 2)
CytoGLMM::plot_prcomp(mu_hat1,
                      protein_names = protein_names,
                      color_var = "term",
                      repel = TRUE)
CytoGLMM::plot_prcomp(mu_hat2,
                      protein_names = protein_names,
                      color_var = "donor",
                      repel = TRUE)
CytoGLMM::plot_mds(mu_hat1,
                   protein_names = protein_names,
                   sample_info_names = c("donor","term"),
                   color = "term")
```
